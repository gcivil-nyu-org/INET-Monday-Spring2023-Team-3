...
class TestModels(TestCase):
    ...
    def setUpCP(self):
        return CrawlPoint.objects.create(crawl = Crawl.objects.create(title = 'testcrawl1'), point = Point.objects.create(title = 'testpoint1'))
    ...
    def setUpCT(self):
        return CrawlTag.objects.create(tag = Tag.objects.create(title = 'testtag1'), crawl = Crawl.objects.create(title = 'testcrawl1'))
